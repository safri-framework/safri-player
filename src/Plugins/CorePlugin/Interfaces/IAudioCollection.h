...
namespace Core
{
    ...
    public:
        ...
        virtual Song* newSong(QString name) = 0;
        ...
        virtual Artist* newArtist(QString name) = 0;
        ...
        virtual Album* newAlbum(QString album) = 0;
        ...
        virtual Genre* newGenre(QString genre) = 0;
